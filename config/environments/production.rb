Rails.application.configure do
  ...
  config.log_level = ENV['LOG_LEVEL'].in?(%w(debug info warn error fatal unknown)) ? ENV['LOG_LEVEL'].to_sym : :info
  ...
  # config.active_job.queue_name_prefix = "skeinlink_production"
